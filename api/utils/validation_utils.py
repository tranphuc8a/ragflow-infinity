...
class ParserConfig(Base):
    ...
    doxa_token: Annotated[str | None, Field(default=None, max_length=65535)]
    doxa_url: Annotated[str | None, Field(default=None, max_length=65535)]
    doxa_ipaas_token: Annotated[str | None, Field(default=None, max_length=65535)]
    doxa_parse_method: Annotated[str | None, Field(default=None, max_length=255)]
    doxa_options: Annotated[dict[str, Any], Field(default_factory=dict)]
