export default {
  translation: {
    ...
    knowledgeConfiguration: {
      ...
      doxaOptions: 'Tùy chọn DoXA',
      doxaParseMethod: 'Phương thức phân tích',
      doxaParseMethodTip: 'Chế độ phân tích cho trình phân tích DoXA.',
      doxaApiBase: 'URL gốc API DoXA',
      doxaApiBaseTip: 'URL gốc cho dịch vụ API DoXA.',
      doxaApiBasePlaceholder: 'Ví dụ: https://api.doxa.example.com',
      doxaApiToken: 'Token API DoXA',
      doxaApiTokenTip: 'Token dùng để xác thực với API DoXA.',
      doxaApiTokenPlaceholder:
        'Nhập token DoXA (tùy chọn nếu đã cấu hình biến môi trường)',
      doxaIpaasToken: 'Token iPaaS DoXA',
      doxaIpaasTokenTip: 'Token iPaaS tùy chọn cho cổng riêng của DoXA.',
      doxaIpaasTokenPlaceholder: 'Nhập token iPaaS (tùy chọn)',
    },
    chunk: {
      chunk: 'Khối',
      bulk: 'Hàng loạt',
